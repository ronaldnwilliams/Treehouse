...
public class CheckoutControllerTest {
	...
	@Test
	public void renderedViewContainsSubTotalTest() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/checkout/coupon"))
				.andDo(print())
	...
	@Test
	public void postInvalidCouponTest() throws Exception {
