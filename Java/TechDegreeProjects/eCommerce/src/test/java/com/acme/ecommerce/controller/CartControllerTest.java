...
public class CartControllerTest {
	...
	static {
		System.setProperty("properties.home", "/Users/ronaldwilliams/IdeaProjects/Treehouse Java Projects/ecommerce/src/main/resources");
	}
	...
	@Test
	public void NotEnoughStockAddCartTest() throws Exception {
		Product product = productBuilder();
		String quantity =  Integer.toString(product.getQuantity() + 1);
	...
	@Test
	public void NotEnoughStockUpdateCartTest() throws Exception {
		Product product = productBuilder();
		String quantity =  Integer.toString(product.getQuantity() + 1);
	...
	@Test
	public void addToCartFlashTest() throws Exception {
		Product product = productBuilder();
	...
	@Test
	public void updateCartFlashTest() throws Exception {
		Product product = productBuilder();
	...
	@Test
	public void removeFromCartFlashTest() throws Exception {
		Product product = productBuilder();
	...
	@Test
	public void emptyCartFlashTest() throws Exception {
		Product product = productBuilder();
