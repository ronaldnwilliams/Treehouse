...
public class ApiTest {
    ...
    @Test
    public void addingCoursesReturnCreatedTest() throws Exception {
    ...
    public void addingReviewGivesCreatedStatus() throws Exception {
        ...
        ApiResponse response = client.request("POST", String.format("/courses/%d/reviews", course.getId()),
                gson.toJson(values));
    ...
    public void addingReviewToUnknownCourseThrowsError() throws Exception {
        ...
        ApiResponse response = client.request("POST", "/courses/42/reviews",
                gson.toJson(values));
